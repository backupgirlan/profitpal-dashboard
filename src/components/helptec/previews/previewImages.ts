...
import siteCalcados from "@/assets/previews/site-calcados.jpg";
import siteCelulares from "@/assets/previews/site-celulares.jpg";
import siteRoupas from "@/assets/previews/site-roupas.jpg";
import siteMoveis from "@/assets/previews/site-moveis.jpg";
import siteCosmeticos from "@/assets/previews/site-cosmeticos.jpg";
...
import sistemaDelivery from "@/assets/previews/sistema-delivery.jpg";
import sistemaEscolar from "@/assets/previews/sistema-escolar.jpg";
import sistemaAcademia from "@/assets/previews/sistema-academia.jpg";
import sistemaBarbearia from "@/assets/previews/sistema-barbearia.jpg";
import sistemaClinica from "@/assets/previews/sistema-clinica.jpg";
import sistemaImobiliaria from "@/assets/previews/sistema-imobiliaria.jpg";
import sistemaOficina from "@/assets/previews/sistema-oficina.jpg";
import sistemaRestaurante from "@/assets/previews/sistema-restaurante.jpg";
import sistemaSupermercado from "@/assets/previews/sistema-supermercado.jpg";
import sistemaSalao from "@/assets/previews/sistema-salao.jpg";
...
import appCompras from "@/assets/previews/app-compras.jpg";
import appCabeleireiro from "@/assets/previews/app-cabeleireiro.jpg";
import appClinica from "@/assets/previews/app-clinica.jpg";
...
import iaAtendimento from "@/assets/previews/ia-atendimento.jpg";
...
import landingBarbearia from "@/assets/previews/landing-barbearia.jpg";
import landingGastronomia from "@/assets/previews/landing-gastronomia.jpg";
import landingImobiliaria from "@/assets/previews/landing-imobiliaria.jpg";
import landingEcommerce from "@/assets/previews/landing-ecommerce.jpg";
import landingBeleza from "@/assets/previews/landing-beleza.jpg";
import landingEventos from "@/assets/previews/landing-eventos.jpg";
import landingDentista from "@/assets/previews/landing-dentista.jpg";
...
import lojaPet from "@/assets/previews/loja-pet.jpg";
import lojaSupermercado from "@/assets/previews/loja-supermercado.jpg";
import lojaCalcados from "@/assets/previews/loja-calcados.jpg";
import lojaJoias from "@/assets/previews/loja-joias.jpg";
import lojaInfantil from "@/assets/previews/loja-infantil.jpg";
import lojaAgropecuaria from "@/assets/previews/loja-agropecuaria.jpg";
import lojaNaturais from "@/assets/previews/loja-naturais.jpg";

type ImageMap = { keywords: string[]; src: string }[];

const siteImages: ImageMap = [
  { keywords: ["cosméticos", "cosmeticos", "skincare", "maquiagem"], src: siteCosmeticos },
  { keywords: ["calçados", "calcados", "sapataria", "sapato", "tênis", "tenis"], src: siteCalcados },
  { keywords: ["celulares", "celular", "tecnologia", "smartphone", "eletrônicos", "eletronicos"], src: siteCelulares },
  { keywords: ["roupas", "moda", "vestuário", "vestuario", "feminina", "masculina"], src: siteRoupas },
  { keywords: ["móveis", "moveis", "decoração", "decoracao", "sofá", "sofa", "mesa"], src: siteMoveis },
  { keywords: ["supermercado", "mercado", "agropecuária", "agropecuario", "açougue", "acougue"], src: siteSupermercado },
  { keywords: ["barbearia", "barber"], src: siteBeleza },
  { keywords: ["cabeleireiro", "cabelo"], src: siteBeleza },
  { keywords: ["salão", "salao", "beleza", "manicure", "spa"], src: siteBeleza },
  { keywords: ["estética", "estetica"], src: siteBeleza },
  { keywords: ["restaurante", "lanchonete", "padaria", "confeitaria", "cafeteria", "bar", "sushi"], src: siteRestaurante },
  { keywords: ["hamburgueria", "hambúrguer", "hamburguer"], src: siteRestaurante },
  { keywords: ["pizzaria", "pizza"], src: siteRestaurante },
  ...
  { keywords: ["hotel", "pousada", "resort", "hospedagem", "hostel", "airbnb", "chalé", "chale", "hotelaria"], src: siteHotel },
  ...
  { keywords: ["oficina", "mecânica", "mecanica", "auto center", "funilaria"], src: siteOficina },
  { keywords: ["autopeças", "autopecas", "automotivo"], src: siteOficina },
...
const sistemaImages: ImageMap = [
  { keywords: ["delivery", "entrega"], src: sistemaDelivery },
  { keywords: ["escolar", "escola", "educação", "educacao", "aluno", "estudante"], src: sistemaEscolar },
  { keywords: ["academia", "fitness", "treino", "gym"], src: sistemaAcademia },
  { keywords: ["barbearia", "barber"], src: sistemaBarbearia },
  { keywords: ["clínica", "clinica", "saúde", "saude", "médico", "medico", "estética", "estetica"], src: sistemaClinica },
  { keywords: ["imobiliária", "imobiliaria", "imobiliário", "imobiliario", "imóvel", "imovel"], src: sistemaImobiliaria },
  { keywords: ["oficina", "mecânica", "mecanica", "automotivo", "auto center", "veículo", "veiculo"], src: sistemaOficina },
  { keywords: ["restaurante", "gastronomia", "cozinha", "cardápio", "cardapio", "alimentação", "alimentacao"], src: sistemaRestaurante },
  { keywords: ["supermercado", "mercado", "mercearia"], src: sistemaSupermercado },
  { keywords: ["salão", "salao", "beleza", "cabeleireiro", "cabelo"], src: sistemaSalao },
  ...
  { keywords: ["gestão", "gestao", "administrativo", "loja", "roupas", "sapataria", "funcionários", "ordens", "moda", "calçados", "calcados", "corporativo", "escritório", "escritorio"], src: sistemaGestao },
];

const appImages: ImageMap = [
  { keywords: ["barbearia", "barber"], src: appBarbearia },
  { keywords: ["cabeleireiro", "cabelo"], src: appCabeleireiro },
  { keywords: ["salão", "salao"], src: appCabeleireiro },
  { keywords: ["compras", "lista", "varejo"], src: appCompras },
  { keywords: ["farmácia", "farmacia", "medicamento", "drogaria"], src: appFarmacia },
  { keywords: ["clínica", "clinica", "saúde", "saude", "médico", "medico", "paciente", "consulta", "exame"], src: appClinica },
  ...
  { keywords: ["fidelidade", "loyalty", "pontos", "recompensa", "cashback", "cupom"], src: appFidelidade },
  ...
  { keywords: ["supermercado", "mercado", "mercearia"], src: appSupermercado },
  { keywords: ["beleza"], src: appAgendamento },
];

const iaImages: ImageMap = [
  { keywords: ["whatsapp", "zap"], src: iaWhatsapp },
  { keywords: ["chatbot", "bot"], src: iaChatbot },
  { keywords: ["chat online"], src: iaAtendimento },
  { keywords: ["suporte", "técnico", "tecnico", "help desk", "ticket"], src: iaSuporte },
  { keywords: ["atendimento automático", "atendimento automatico", "atendimento"], src: iaAtendimento },
  { keywords: ["assistente de vendas"], src: iaVendas },
  ...
  { keywords: ["dashboard", "inteligente", "kpi"], src: iaDashboard },
  { keywords: ["gestão", "gestao"], src: iaDashboard },
  ...
  { keywords: ["vendas", "venda", "comercial"], src: iaVendas },
  { keywords: ["produto"], src: iaRecomendacao },
];

const landingImages: ImageMap = [
  { keywords: ["barbearia", "barber"], src: landingBarbearia },
  ...
  { keywords: ["dentista", "odontologia", "ortodontia"], src: landingDentista },
  { keywords: ["clínica", "clinica", "saúde", "saude"], src: landingFitness },
  { keywords: ["curso", "aula", "mentoria", "treinamento", "workshop", "educação", "educacao"], src: landingCurso },
  { keywords: ["consultoria", "serviço", "servico", "advogado", "energia", "freelancer", "profissional", "agência", "agencia"], src: landingServicos },
...
const lojaImages: ImageMap = [
  { keywords: ["agropecuária", "agropecuario", "agro", "rural", "fazenda"], src: lojaAgropecuaria },
  { keywords: ["pet", "petshop", "pet shop", "animal", "cachorro", "gato"], src: lojaPet },
  { keywords: ["supermercado", "mercado", "mercearia"], src: lojaSupermercado },
  { keywords: ["calçados", "calcados", "sapato", "sapataria", "tênis", "tenis"], src: lojaCalcados },
  { keywords: ["joias", "jóias", "relógios", "relogios", "acessórios", "acessorios", "bijuteria", "ouro", "prata"], src: lojaJoias },
  { keywords: ["brinquedos", "infantil", "criança", "crianca", "bebê", "bebe", "kids"], src: lojaInfantil },
  { keywords: ["natural", "naturais", "orgânico", "organico", "suplemento", "saudável", "saudavel"], src: lojaNaturais },
  { keywords: ["roupas", "moda", "feminina", "masculina", "vestuário", "vestuario", "bolsas"], src: lojaRoupas },
  ...
  { keywords: ["alimentos", "comida", "bebidas", "doces", "cesta"], src: lojaAlimentos },
  { keywords: ["cosméticos", "cosmeticos", "beleza", "perfume", "maquiagem", "skincare", "cuidados", "cabelo", "unha", "hidratante"], src: lojaCosmeticos },
  { keywords: ["esportes", "esportivo", "bike", "bicicleta", "camping", "pesca", "surf", "skate"], src: lojaEsportes },
  { keywords: ["móveis", "moveis", "decoração", "decoracao", "cozinha", "quarto", "sala", "colchão", "colchao", "sofá", "sofa", "mesa", "cadeira"], src: lojaMoveis },
];
