      ...
      <section className="py-14 sm:py-20 bg-card/50 relative overflow-hidden">
        ...
        <div className="relative max-w-[90rem] mx-auto px-4 sm:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger} className="text-center mb-10">
            ...
            <motion.p variants={fadeUp} className="text-sm text-muted-foreground max-w-lg mx-auto">
            ...
            <motion.div variants={fadeUp} className="bg-card border border-border rounded-2xl overflow-hidden hover:border-primary/30 transition-all hover:shadow-[0_0_40px_hsla(45,100%,50%,0.08)] group">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  <a href="https://www.youtube.com/@TechnicalGirlan" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 rounded-xl border border-destructive/40 bg-destructive/10 px-4 py-3 text-sm font-display font-bold text-destructive hover:bg-destructive/20 transition-all hover:scale-[1.02]">
                    <Youtube className="h-5 w-5" /> YouTube
                  </a>
                  <a href="https://t.me/girlananalyst" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 rounded-xl border border-ring/40 bg-ring/10 px-4 py-3 text-sm font-display font-bold text-ring hover:bg-ring/20 transition-all hover:scale-[1.02]">
